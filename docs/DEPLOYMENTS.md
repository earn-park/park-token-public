...
| Implementation (`ParkTokenV1_1`) | [`0x885C40D264B31487d56d5391b74BCced48a9ba0A`](https://bscscan.com/address/0x885C40D264B31487d56d5391b74BCced48a9ba0A) — implVersion `v1.1.0`, admin `mint` removed |
...
| Total supply / cap | 1,000,000,000 PARK (fixed cap; **strictly non-increasing since v1.1.0 — admin mint removed**; holder burn only) |
...
| Safe | Address | Role |
|---|---|---|
| Admin | [`0xBE26469075864F48806dE7be55Fa12b5f9a00f78`](https://bscscan.com/address/0xBE26469075864F48806dE7be55Fa12b5f9a00f78) | `DEFAULT_ADMIN_ROLE` (metadata, rescuer admin — **no mint as of v1.1.0**) + Timelock `PROPOSER_ROLE` |
...
- **2026-06-22** — Upgraded to **v1.1.0** (impl `0x885C40…ba0A`): the admin `mint`
  function is **removed** — supply is now strictly non-increasing (holder burn
  only). Proxy unchanged; balances / supply / cap preserved. Execute tx
